(function () {
	...
	/**
	 * Introduce the mvpHrApp.admin.user.list module
	 * and configure it.
	 *
	 * @requires ui.router
	 * @requires ngMaterial
	 * @requires {mvpHrApp.socket}
	 * @requires mvpHrApp.mainMenu
	 * @requires components/toggleComponent
	 * @requires mvpHrApp.admin.user.list.detail
	 * @requires mvpHrApp.admin.user.list.edit
	 * @requires mvpHrApp.admin.user.list.items
	 */

	angular
		.module('mvpHrApp.admin.user.list', [
			'ngMaterial',
			'ui.router',
			'mvpHrApp.socket',
			'mvpHrApp.mainMenu',
			'mvpHrApp.toggleComponent',
			'mvpHrApp.admin.user.list.detail',
			'mvpHrApp.admin.user.list.edit',
			'mvpHrApp.admin.user.list.items'
		])
