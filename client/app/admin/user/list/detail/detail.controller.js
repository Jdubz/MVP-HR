/**
 * @ngdoc controller
 * @name mvpHrApp.admin.user.list.detail.controller:UserDetailController
 * @description
...
(function () {
	 ...
	 */
	angular
		.module('mvpHrApp.admin.user.list.detail')
		.controller('UserDetailController', UserDetailController);

	/**
	 * @ngdoc function
	 * @name mvpHrApp.admin.user.list.detail.provider:UserDetailController
	 * @description
	 * Provider of the {@link mvpHrApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
	 *
	 ...
	 * @returns {Service} {@link mvpHrApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
	 */
	...
	function UserDetailController($state, user, Auth) {
		 ...
		 * @ngdoc property
		 * @name user
		 * @propertyOf mvpHrApp.admin.user.list.detail.controller:UserDetailController
		 * @description
		 ...
		 * @ngdoc function
		 * @name edit
		 * @methodOf mvpHrApp.admin.user.list.detail.controller:UserDetailController
		 * @description
