/**
 * @ngdoc overview
 * @name mvpHrApp.admin.user.list.detail
 * @description
 * The `mvpHrApp.admin.user.list.detail` module which provides:
 *
 * - {@link mvpHrApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires mvpHrApp.auth.user
 */
(function () {
	'use strict';
