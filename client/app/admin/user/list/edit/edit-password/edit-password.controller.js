/**
 * @ngdoc controller
 * @name mvpHrApp.admin.user.list.edit.controller:EditPasswordController
 * @description
...
(function () {
	...
	angular
		.module('mvpHrApp.admin.user.list.edit')
		.controller('EditPasswordController', EditPasswordController);


	/**
	 * @ngdoc function
	 * @name mvpHrApp.admin.user.list.edit.provider:EditPasswordController
	 * @description
	 * Provider of the {@link mvpHrApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
	 *
	 ...
	 * @returns {Service} {@link mvpHrApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
	 */
	...
	function EditPasswordController($mdDialog, UserService, user, Toast) {
		 ...
		 * @ngdoc function
		 * @name changePassword
		 * @methodOf mvpHrApp.admin.user.list.edit.controller:EditPasswordController
		 * @description
