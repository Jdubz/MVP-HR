/**
 * @ngdoc controller
 * @name mvpHrApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name mvpHrApp.admin.user.list.edit.provider:UserEditController
	 * @description
	 * Provider of the {@link mvpHrApp.admin.user.list.edit.controller:UserEditController UserEditController}
