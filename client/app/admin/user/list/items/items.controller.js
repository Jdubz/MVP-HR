/**
 * @ngdoc controller
 * @name mvpHrApp.admin.user.list.items.controller:UserItemsController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name mvpHrApp.admin.user.list.items.provider:UserItemsController
	 * @description
	 * Provider of the {@link mvpHrApp.admin.user.list.items.controller:UserItemsController UserItemsController}
	 *
	 */
	...
	function UserItemsController($state, Auth) {
		 ...
		 * @ngdoc function
		 * @name isSelected
		 * @methodOf mvpHrApp.admin.user.list.items.controller:UserItemsController
		 * @description
