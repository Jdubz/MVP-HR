(function () {
	...
	/**
	 * Introduce the mvpHrApp.user module
	 * and configure it.
	 *
	 * @requires ngResource
	 * @requires ui.router
	 * @requires {mvpHrApp.admin.user.list}
	 * @requires {mvpHrApp.admin.user.create}
	 */
	angular
		.module('mvpHrApp.admin.user', [
			'ngResource',
			'ui.router',
			'mvpHrApp.admin.user.list',
			'mvpHrApp.admin.user.create'
		])
