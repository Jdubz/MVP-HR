/**
 * @ngdoc controller
 * @name mvpHrApp.admin.user.create.controller:UserCreateController
 * @description
...
(function () {
	...
	angular
		.module('mvpHrApp.admin.user.create')
		.controller('UserCreateController', UserCreateController);

	/**
	 * @ngdoc function
	 * @name mvpHrApp.admin.user.create.provider:UserCreateController
	 * @description
	 * Provider of the {@link mvpHrApp.admin.user.create.controller:UserCreateController UserCreateController}
	 *
	 ...
	 * @returns {Service} {@link mvpHrApp.admin.user.create.controller:UserCreateController UserCreateController}
	 */
	...
	function UserCreateController($mdDialog, Auth, User, Toast) {
		 ...
		 * @ngdoc property
		 * @name userRoles
		 * @propertyOf mvpHrApp.admin.user.create.controller:UserCreateController
		 * @description
		 ...
		 * @ngdoc function
		 * @name create
		 * @methodOf mvpHrApp.admin.user.create.controller:UserCreateController
		 * @description
