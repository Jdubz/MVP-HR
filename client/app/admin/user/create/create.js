/**
 * @ngdoc overview
 * @name mvpHrApp.admin.user.create
 * @description
 * The `mvpHrApp.admin.user.create` module which provides
 *
 * - {@link mvpHrApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
...
(function () {
	...
	angular
		.module('mvpHrApp.admin.user.create', [
			...
			'mvpHrApp.auth',
			'mvpHrApp.toast',
			'mvpHrApp.remoteUnique',
			'mvpHrApp.mongooseError'
		])
